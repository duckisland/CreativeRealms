var Item = [{
  ...
  ID: 14,
  Description: "ornate key",
  Type: "Key",
  Value: 25
},{
  ID: 15,
  Description: "banker's key",
  Type: "Key",
  Value: 50
},{
  ID: 16,
  Description: "noble key",
  Type: "Key",
  Value: 100
},{
  ID: 20,
